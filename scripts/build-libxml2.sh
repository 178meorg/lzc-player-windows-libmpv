...
NAME="libxml2-${LIBXML2_VERSION}"
SRC_DIR="${SRC_ROOT}/${NAME}"
BUILD_DIR="${WORK_ROOT}/${NAME}"
TARBALL="${SRC_ROOT}/${NAME}.tar.xz"
URL="https://download.gnome.org/sources/libxml2/${LIBXML2_VERSION%.*}/${NAME}.tar.xz"
...
echo "==> libxml2 ${LIBXML2_VERSION} installed as static library"
